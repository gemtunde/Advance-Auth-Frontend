        ...
        {user?.userPreferences?.enable2FA ? (
          ...
          <Dialog modal open={isOpen} onOpenChange={setIsOpen}>
            <DialogTrigger asChild>
              <Button
                disabled={isLoading}
                className="h-[35px] text-white bg-blue-500 hover:bg-blue-700"
              >
                Enable MFA
              </Button>
            </DialogTrigger>
                ...
                {showKey ? (
                  <div className="w-full">
                    ...
                    >
                      ...
                      <button
                        disabled={isCopied}
                        onClick={() => handleCopy(mfaData?.qrImageUrl)}
                      >
                        {isCopied ? (
              ...
              <div className="mt-8 border-t">
                <Form {...form}>
                  ...
                  >
                    ...
                    <Button
                      disabled={isPending}
                      className="w-full bg-blue-500 text-white hover:bg-blue-700 h-[40px]"
                    >
                      Verify
                      {isPending && (
